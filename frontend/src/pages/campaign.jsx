...
export default function Campaign() {
  return (
    <div>
      <Navbar />
      <div className="relative h-[213.029px]">
        <img src={ImagePhoto} alt="" className="w-full h-full object-cover" />
        <div className="absolute inset-0 flex justify-center items-center">
          <h1 className="text-primary font-medium text-center text-md px-[10%]">
      ...
      <div className="flex flex-col items-center px-[5%] py-5 text-primary">
        ...
        <div className="flex flex-col gap-3 w-full">
          <div className="flex flex-col gap-1">
            <h1 className="font-semibold">Ikut Berpartisipasi</h1>
            <a className="btn btn-block rounded-xl border border-primary font-bold text-primary">
              Ikut Acara
            </a>
          </div>
          <div className="flex flex-col gap-1">
            <h1 className="font-semibold">Jadwal Pelaksanaan</h1>
            <table>
              <tbody>
                <tr>
                  <td>Mulai</td>
          ...
          <div>
            ...
            <p className="whitespace-pre-line text-sm">{`Kolaborasi pemerintah dan swasta berperan penting dalam peningkatan akses masyarakat terhadap air bersih dan sanitasi. Saat ini, akses terhadap air minum yang layak telah mencapai 91,72 persen berdasarkan data Badan Pusat Statistik (BPS) tahun 2023.
