            ...
            <div className="flex flex-col justify-between w-full lg:w-[900px] px-4 mb-4 pb-4 lg:mb-0 lg:pb-0 lg:justify-start flex-grow lg:p-11  xl:p-16">
                <div>
                    ...
                    <p className="mt-2 text-justify">
                        ...
                        Sebelumnya, Pemerintah Indonesia telah menetapkan Rencana Jangka Panjang Menengah Nasional (RPJMN) dengan target 100 persen akses air minum layak pada tahun 2020-2024. Hal ini tertuang dalam Lampiran II Perpres Nomor 18 Tahun 2020. <span><a href=""><strong>Baca Selengkapnya</strong></a></span>
                    </p>
