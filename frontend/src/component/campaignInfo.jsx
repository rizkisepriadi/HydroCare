        ...
        <div className="p-4 rounded-lg shadow-lg">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mb-6 text-center md:mb-8">
              Baik untuk kebutuhan pribadi, isu sosial, atau ide kreatif, Anda
              dapat mengandalkan kami untuk kampanye yang ingin Anda lakukan.
            </p>
          </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 text-center w-[900px]">
              ...
              <div className="w-[200px] p-4 bg-[#0063A7] rounded-lg">
                ...
                <h3 className="text-white">
                  Berfokus pada akses dan kualitas air bersih
                </h3>
              </div>
            </div>
          </div>
